...
sequenceDiagram
    ...
    rect rgb(10, 0, 20)
        Note over N,S: 🗄️ Phase 5 — Persistence (FSM: VALIDATING → COMPLETED)
...
```mermaid
flowchart TD
    A["🖥️ Main Dashboard Layout"]:::root --> B["🔬 Scanner Column"]:::scanner
    A --> C["📊 Vitals Column"]:::vitals
    A --> D["💊 Interactions Column"]:::drug

    B --> B1["🗂️ Dropzone Component"]:::scanner
    B --> B2["🖼️ Canvas Preview + WebGL"]:::scanner
    B --> B3["🔄 FSM Processing Overlay"]:::scanner

    C --> C1["📈 VitalsMonitor · Recharts"]:::vitals
    C --> C2["🔁 React Query Polling"]:::vitals
    C --> C3["📄 jsPDF Export Button"]:::vitals

    D --> D1["⚠️ InteractionList"]:::drug
    D --> D2["🏥 NIH RxNav Drug DB"]:::drug
    D --> D3["🔴🟡🟢 SeverityBadge"]:::drug
...
[![Next.js](https://img.shields.io/badge/Next.js_15-App_Router_+_Edge_Middleware-000?style=flat-square&logo=next.js)](https://nextjs.org/)
[![React](https://img.shields.io/badge/React_19-use_hook_+_Server_Components-61DAFB?style=flat-square&logo=react&logoColor=000)](https://react.dev/)
[![TypeScript](https://img.shields.io/badge/TypeScript_5.3-Strict_+_Template_Literal_Types-3178C6?style=flat-square&logo=typescript)](https://typescriptlang.org/)
[![React Query](https://img.shields.io/badge/React_Query-SWR_+_Background_Refetch-FF4154?style=flat-square)](https://tanstack.com/query)
[![Tailwind](https://img.shields.io/badge/Tailwind_CSS-JIT_+_Custom_Plugins-06B6D4?style=flat-square&logo=tailwindcss&logoColor=fff)](https://tailwindcss.com/)
...
```mermaid
pie title RxScan AI — Technical Specialisation
...
<img src="https://github.com/salonyranjan.png" width="130" style="border-radius:50%;" alt="Salony Ranjan" />
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/salony-ranjan-b63200280/)
&nbsp;
[![GitHub](https://img.shields.io/badge/GitHub-Follow-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/salonyranjan)
&nbsp;
[![Email](https://img.shields.io/badge/Email-Contact-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:salonyranjan@gmail.com)
&nbsp;
[![Portfolio](https://img.shields.io/badge/Portfolio-Visit-00f3ff?style=for-the-badge&logo=react&logoColor=black)](https://vertex-flow-phi.vercel.app/)
...
[![Star](https://img.shields.io/badge/⭐_Star_This_Repo-00f3ff?style=for-the-badge&logo=github&logoColor=black)](https://github.com/salonyranjan/rxscan-ai/stargazers)
&nbsp;
[![Fork](https://img.shields.io/badge/🍴_Fork_&_Build-ff00ff?style=for-the-badge&logo=github&logoColor=white)](https://github.com/salonyranjan/rxscan-ai/fork)
&nbsp;
[![Feature Request](https://img.shields.io/badge/💡_Feature_Request-ffaa00?style=for-the-badge&logoColor=black)](https://github.com/salonyranjan/rxscan-ai/issues/new?template=feature_request.md)

<br/><br/>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:00f3ff,35:006680,65:4d0066,85:ffaa00,100:000000&height=140&section=footer&animation=fadeIn" />

<br/>

*Engineered with* 💊 *by* **[Salony Ranjan](https://github.com/salonyranjan)** &nbsp;·&nbsp; *© 2026 RxScan AI · MIT License*

<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=12&duration=4000&pause=1000&color=00f3ff&center=true&vCenter=true&width=600&lines=SYSTEM+STATUS%3A+VISION+PIPELINE+ONLINE+💊;GROQ+INFERENCE%3A+50ms+%7C+NIH+RXNAV%3A+CONNECTED+✅;STAY+SHARP+·+SCAN+SMART+·+HEAL+BETTER" />

...
<img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&weight=900&size=21&pause=1000&color=00f3ff&center=true&vCenter=true&width=980&height=55&lines=💊+Prescription+OCR+via+Groq+Llama-4+Scout+%7C+50ms+Inference;🧬+FSM-Driven+Validation+%7C+IDLE+→+UPLOADING+→+COMPLETED;📊+Real-Time+Biometric+Vitals+%7C+Recharts+Glassmorphic+Monitor;🔐+HIPAA+AES-256+%7C+OWASP+Top+10+%7C+NIH+RxNav+Integration" alt="Typing SVG" />
...
<img src="https://img.shields.io/badge/Groq-Llama_4_Scout-000000?style=for-the-badge&logo=groq&logoColor=white" />
<img src="https://img.shields.io/badge/Prisma-ORM-2D3748?style=for-the-badge&logo=prisma&logoColor=white" />

<br/>

<img src="https://img.shields.io/badge/Tailwind_CSS-JIT-06B6D4?style=for-the-badge&logo=tailwindcss&logoColor=white" />
<img src="https://img.shields.io/badge/SQLite→PostgreSQL-003B57?style=for-the-badge&logo=sqlite&logoColor=white" />
<img src="https://img.shields.io/badge/NIH_RxNav-API-00f3ff?style=for-the-badge" />
<img src="https://img.shields.io/badge/Recharts-Vitals-ff00ff?style=for-the-badge" />
<img src="https://img.shields.io/badge/jsPDF-Export-ffaa00?style=for-the-badge" />

<br/>

<img src="https://img.shields.io/badge/HIPAA-Compliant-00f3ff?style=for-the-badge" />
<img src="https://img.shields.io/badge/AES--256-Encrypted-ff00ff?style=for-the-badge" />
<img src="https://img.shields.io/badge/Vercel-Edge_Deploy-000000?style=for-the-badge&logo=vercel&logoColor=white" />
<img src="https://img.shields.io/badge/Docker-Multi--Stage-2496ED?style=for-the-badge&logo=docker&logoColor=white" />
<img src="https://img.shields.io/badge/License-MIT-00f3ff?style=for-the-badge" />

<br/>

<img src="https://img.shields.io/github/stars/salonyranjan/rxscan-ai?style=for-the-badge&color=00f3ff" />
<img src="https://img.shields.io/github/forks/salonyranjan/rxscan-ai?style=for-the-badge&color=ff00ff" />
<img src="https://img.shields.io/github/last-commit/salonyranjan/rxscan-ai?style=for-the-badge&color=ffaa00" />
...
<a href="#12--getting-started"><img src="https://img.shields.io/badge/📦_Quick_Setup-00f3ff?style=for-the-badge&logoColor=black" /></a>
&nbsp;
<a href="#5--feature-orchestration-architecture"><img src="https://img.shields.io/badge/🧬_Pipeline_Diagram-ff00ff?style=for-the-badge" /></a>
&nbsp;
<a href="#9--tech-stack"><img src="https://img.shields.io/badge/🛠️_Tech_Stack-ffaa00?style=for-the-badge&logoColor=black" /></a>
&nbsp;
<a href="#11--roadmap"><img src="https://img.shields.io/badge/🗺️_Roadmap-00f3ff?style=for-the-badge&logoColor=black" /></a>
...
sequenceDiagram
    ...
    participant R  as 🧹 Regex Sanitizer
    participant A  as 🏥 NIH RxNav API
    participant P  as 🔷 Prisma ORM
    participant S  as 🗄️ SQLite / PG
    participant UI as 📊 Hydrated UI

    Note over U,C: 📸 Phase 1 — Image Acquisition
    U->>C: Upload prescription image (drag-and-drop)
    C->>C: EXIF extract, resize to 1024×768, WebP compress
    C->>N: POST /api/vision (multipart/form-data)

    Note over N,G: 🤖 Phase 2 — AI Vision Inference
    N->>G: Vision request — Llama-4 Scout
    G-->>N: Structured JSON (medication, dosage, route, frequency, RxNorm CUI)

    Note over N,R: 🧹 Phase 3 — Sanitization
    N->>R: Raw extraction → Regex validation & normalisation
    R-->>N: Cleaned PrescriptionObject (base-10 dosage, normalised frequency)

    Note over N,A: 💊 Phase 4 — Drug Interaction Check
    N->>A: Lookup drug interactions via RxNorm CUI
    A-->>N: Interaction warnings + severity classification

    Note over N,S: 🗄️ Phase 5 — Persistence
    N->>P: createPrescriptionScan(data)
    P->>S: INSERT record
    S-->>P: prescription_id
    P-->>N: 200 OK + prescription_id

    Note over C,UI: 📊 Phase 6 — Client Hydration
    N-->>C: { prescription_id, interactions }
    C->>UI: Poll /api/vitals?scanId= until vitals_ready
    UI-->>C: Render Recharts monitor + interaction panel
```
...
```mermaid
flowchart TD
    A[🖥️ Main Dashboard Layout] --> B[🔬 Scanner Column]
    A --> C[📊 Vitals Column]
    A --> D[💊 Interactions Column]

    B --> B1[🗂️ Dropzone Component]
    B --> B2[🖼️ Canvas Preview + WebGL]
    B --> B3[🔄 FSM Processing Overlay]

    C --> C1[📈 VitalsMonitor Recharts]
    C --> C2[🔁 React Query Polling]
    C --> C3[📄 jsPDF Export Button]

    D --> D1[⚠️ InteractionList]
    D --> D2[🏥 NIH RxNav Drug DB]
    D --> D3[🔴🟡🟢 SeverityBadge]
    ...
    classDef scanner fill:#0a1a1a,stroke:#00f3ff,stroke-width:2px,color:#fff;
    classDef vitals fill:#0a001a,stroke:#ff00ff,stroke-width:2px,color:#fff;
    classDef drug fill:#1a0a00,stroke:#ffaa00,stroke-width:2px,color:#fff;
    classDef root fill:#0a0a0a,stroke:#fff,stroke-width:2px,color:#fff;

    class A root;
    class B,B1,B2,B3 scanner;
    class C,C1,C2,C3 vitals;
    class D,D1,D2,D3 drug;
```
...
<p>
  <img src="https://img.shields.io/badge/Recharts-Custom_SVG-ff00ff?style=for-the-badge" />
  <img src="https://img.shields.io/badge/CSS_Keyframes-Synthwave_Anims-00f3ff?style=for-the-badge" />
  <img src="https://img.shields.io/badge/WebGL_Shaders-Dropzone_FX-ffaa00?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Tailwind_Plugins-Neon_Glow-06B6D4?style=for-the-badge" />
  <img src="https://img.shields.io/badge/jsPDF-Cyberpunk_Export-00f3ff?style=for-the-badge" />
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/React-19-61DAFB?style=for-the-badge&logo=react&logoColor=black" />
  <img src="https://img.shields.io/badge/TypeScript-5.3_Strict-3178C6?style=for-the-badge&logo=typescript&logoColor=white" />
  <img src="https://img.shields.io/badge/Tailwind_CSS-JIT-06B6D4?style=for-the-badge&logo=tailwindcss&logoColor=white" />
  <img src="https://img.shields.io/badge/React_Query-Server_State-FF4154?style=for-the-badge" />
</p>
...
<p>
  <img src="https://img.shields.io/badge/Groq-Llama_4_Scout-000000?style=for-the-badge&logo=groq&logoColor=white" />
  <img src="https://img.shields.io/badge/Prisma-ORM-2D3748?style=for-the-badge&logo=prisma&logoColor=white" />
  <img src="https://img.shields.io/badge/NIH_RxNav-Drug_API-00f3ff?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Docker-Multi--Stage-2496ED?style=for-the-badge&logo=docker&logoColor=white" />
  <img src="https://img.shields.io/badge/Vercel-Edge_Deploy-000000?style=for-the-badge&logo=vercel&logoColor=white" />
</p>
...
```mermaid
pie title RxScan AI — Technical Specialization
...
| 🛠️ Tool | 📌 Version | 🔗 Link |
|:---|:---:|:---|
| ![Node](https://img.shields.io/badge/Node.js-339933?style=flat&logo=nodedotjs&logoColor=white) | `≥ 20.x` | [nodejs.org](https://nodejs.org/) |
| ![npm](https://img.shields.io/badge/npm-CB3837?style=flat&logo=npm&logoColor=white) | `≥ 10.x` | Bundled with Node |
...
<table style="border:none;">
  <tr>
    <td align="center" style="border:none;" width="160">
      <img src="https://github.com/salonyranjan.png" width="145" style="border-radius:50%; border:3px solid #00f3ff; box-shadow:0 0 25px #00f3ff, 0 0 50px #ff00ff40;" alt="Salony Ranjan" />
    </td>
    <td style="border:none; padding-left:22px;">
      ...
      &nbsp;
      <a href="https://vertex-flow-phi.vercel.app/"><img src="https://img.shields.io/badge/Portfolio-00f3ff?style=for-the-badge&logo=react&logoColor=black" /></a>
    </td>
  </tr>
</table>
...
<a href="https://github.com/salonyranjan/rxscan-ai/stargazers"><img src="https://img.shields.io/badge/⭐_Star_This_Repo-00f3ff?style=for-the-badge&logo=github&logoColor=black" /></a>
&nbsp;
<a href="https://github.com/salonyranjan/rxscan-ai/fork"><img src="https://img.shields.io/badge/🍴_Fork_&_Build-ff00ff?style=for-the-badge&logo=github&logoColor=white" /></a>
&nbsp;
<a href="https://github.com/salonyranjan/rxscan-ai/issues/new"><img src="https://img.shields.io/badge/💡_Feature_Request-ffaa00?style=for-the-badge&logoColor=black" /></a>

<br/><br/>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:00f3ff,40:ff00ff,75:ffaa00,100:000000&height=130&section=footer&animation=fadeIn" />

<br/>

*Engineered with* 💊 *by* [**Salony Ranjan**](https://github.com/salonyranjan) &nbsp;·&nbsp; *© 2026 RxScan AI · MIT*

<img src="https://readme-typing-svg.herokuapp.com?font=Orbitron&weight=600&size=13&duration=4000&pause=1000&color=00f3ff&center=true&vCenter=true&width=580&lines=SYSTEM+STATUS%3A+VISION+PIPELINE+ONLINE+💊;GROQ+INFERENCE%3A+50ms+%7C+NIH+RXNAV%3A+CONNECTED+✅;STAY+SHARP+·+SCAN+·+HEAL+SMARTER" />

<img src="https://komarev.com/ghpvc/?username=salonyranjan&label=PROFILE+VIEWS&color=00f3ff&style=for-the-badge" />
